...
<template>
  <div>
    ...
    >
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <div
          ...
          :key="award.id"
          class="glass rounded-xl p-6 card-hover border-l-4 border-primary-500 flex flex-col h-full"
        >
          ...
          <p class="text-sm text-gray-600 dark:text-gray-300 mt-auto">
            {{ award.description }}
          </p>
        </div>
      </div>
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
              ...
              :key="edu.id"
              class="glass rounded-xl p-6 card-hover h-full"
            >
        ...
        <div class="space-y-6">
          ...
          <div class="flex flex-wrap gap-3">
            <div
              ...
              :key="cert.id"
              class="glass px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center gap-3"
            >
              <span class="font-bold text-gray-900 dark:text-white">{{ cert.name }}</span>
              <span class="text-sm text-gray-500">{{ cert.date }}</span>
            </div>
            <div
              v-for="lang in profile?.languageSkills"
              :key="lang.id"
              class="glass px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center gap-3"
            >
    ...
    <UPageSection
      title="Activities"
      description="스터디 및 대외활동"
    >
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
          v-for="activity in profile?.activities"
          :key="activity.id"
          class="glass rounded-xl p-5 card-hover border-l-4 border-primary-500"
        >
          <div class="flex justify-between items-start mb-2">
      ...
      <div class="max-w-2xl mx-auto text-center space-y-8">
        <div class="glass rounded-2xl p-8 space-y-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
            <div
              v-if="profile?.personalInfo?.email"
              class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 flex items-center gap-4"
            >
            ...
            <div
              v-if="profile?.personalInfo?.phone"
              class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 flex items-center gap-4"
            >
              <div class="w-12 h-12 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center">
                <UIcon
